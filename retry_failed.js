...
const start = async function () {
  ...
  fs.writeFileSync("successOnRetryNumberList.json", JSON.stringify(successNumberList));
  fs.writeFileSync("failedOnRetryNumberList.json", JSON.stringify(failedNumberList));
